    ...
    <v-content>
      ...
      <v-form @submit.prevent="submitRegister">
        ...
        <v-layout row wrap>
          <v-flex xs12 sm4 id="sign-in-text-wrapper" v-bind:class="{ switch: isSwitch }">
            <v-layout column align-center justify-center fill-height pa-3>
              <div class="login-wrapper text-xs-center mb-3 pa-5">
                ...
                v-if="isSwitch">Enter your personal details and start journey with us</span>
                <span class="subheading"
          ...
          <v-flex xs12 sm8 id="sign-up-form-wrapper"
           class="active" v-bind:class="{ switch: isSwitch}">
